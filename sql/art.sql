...
--
-- Host: 127.0.0.1:3306
-- Erstellungszeit: 01. Apr 2021 um 13:45
...
DROP TABLE IF EXISTS `absenz_anfrage`;
CREATE TABLE IF NOT EXISTS `absenz_anfrage` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `anlass` (
  ...
  `anlassname` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `datum` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `anlass` (`id`, `anlassname`, `datum`) VALUES
(1, 'Vereinsmeisterschaft', '2021'),
(2, 'Fuchsstich', '2021'),
(3, 'Schrotmeisterschaft', '2021'),
(4, 'Gruppenwettkampf', '2021'),
(5, 'Veteranen Cup ', '2021'),
(6, 'Vereinsmeisterschaft', '2022');
...
(4, 'Administrator', '', 'admin', '$2y$10$BQJXQf5ypeK07Qn8BEh1QOO5l1J/t6AgG7DRf/rWJK2D80beKo2.W'),
...
(53, 'Manuel', 'Matter', 'manuel.matter2003@gmail.com', '$2y$10$tW/eFQ8O9VBXVgb7aUjydew9OR6L9Zjfzb0qzqqiTZwIRisBreagW'),
(54, 'Guest', 'User', 'guest', '$2y$10$BQJXQf5ypeK07Qn8BEh1QOO5l1J/t6AgG7DRf/rWJK2D80beKo2.W');
...
CREATE TABLE IF NOT EXISTS `berechtigung` (
  ...
  PRIMARY KEY (`benutzer`,`berechtigung`),
  KEY `berechtigung` (`berechtigung`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `berufsbildner`;
CREATE TABLE IF NOT EXISTS `berufsbildner` (
  `id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `halbtag`;
CREATE TABLE IF NOT EXISTS `halbtag` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`lehrling`,`tag`,`halbtag`),
  KEY `id` (`id`),
  KEY `taetigkeit` (`taetigkeit`),
  KEY `absenz` (`absenz`),
  KEY `lehrling` (`lehrling`)
...
DROP TABLE IF EXISTS `halbtag_korrektur`;
CREATE TABLE IF NOT EXISTS `halbtag_korrektur` (
  `id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `lehrjahr`;
CREATE TABLE IF NOT EXISTS `lehrjahr` (
  `lehrling` int(11) NOT NULL,
  ...
  PRIMARY KEY (`lehrling`,`vertragsjahr`),
  KEY `lehrprofil` (`lehrgang`(1)),
  KEY `lehrprofil_2` (`lehrgang`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `lehrling`;
CREATE TABLE IF NOT EXISTS `lehrling` (
  `id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `nr` (`nr`),
  KEY `berufsbildner` (`berufsbildner`),
  KEY `lehrprofil_2` (`lehrgang`),
  KEY `schule` (`schulort`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `praxisbetrieb`;
CREATE TABLE IF NOT EXISTS `praxisbetrieb` (
  `id` smallint(6) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `praxisbildner`;
CREATE TABLE IF NOT EXISTS `praxisbildner` (
  `id` int(11) NOT NULL,
  `praxisbetrieb` smallint(6) DEFAULT NULL,
  `archiviert` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `praxisbetrieb` (`praxisbetrieb`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `praxiseinsatz`;
CREATE TABLE IF NOT EXISTS `praxiseinsatz` (
  `id` mediumint(9) NOT NULL AUTO_INCREMENT,
  `lehrling` int(11) NOT NULL,
  `startdatum` date NOT NULL,
  `enddatum` date NOT NULL,
  `praxisbildner` int(11) NOT NULL,
  PRIMARY KEY (`lehrling`,`startdatum`),
  UNIQUE KEY `id` (`id`),
  KEY `praxisbildner` (`praxisbildner`),
  KEY `lehrling` (`lehrling`)
...
CREATE TABLE IF NOT EXISTS `rapport` (
  ...
  PRIMARY KEY (`lehrling`,`monat`,`praxisbildner`),
  UNIQUE KEY `rechnungsnr` (`rechnungsnr`),
  KEY `berufsbildner` (`berufsbildner`),
  KEY `praxisbildner` (`praxisbildner`),
  KEY `id_2` (`id`),
  KEY `lehrling` (`lehrling`)
...
DROP TABLE IF EXISTS `rapport_abgelehnt`;
CREATE TABLE IF NOT EXISTS `rapport_abgelehnt` (
  `id` int(11) NOT NULL,
  `benutzer` int(11) NOT NULL,
  `datum` datetime NOT NULL,
  `nachricht` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `abgelehnt` (`benutzer`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `resultate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `schuetze_id` int(11) NOT NULL,
  `anlass_id` int(11) NOT NULL,
  `vmReh1` int(11) DEFAULT NULL,
  `vmReh2` int(11) DEFAULT NULL,
  `vmReh3` int(11) DEFAULT NULL,
  `vmGams1` int(11) DEFAULT NULL,
  `vmGams2` int(11) DEFAULT NULL,
  `vmGams3` int(11) DEFAULT NULL,
  `vmKlapphas1` int(11) DEFAULT NULL,
  `vmKlapphas2` int(11) DEFAULT NULL,
  `vmKlapphas3` int(11) DEFAULT NULL,
  `vmRollhas1` int(11) DEFAULT NULL,
  `vmRollhas2` int(11) DEFAULT NULL,
  `vmRollhas3` int(11) DEFAULT NULL,
  `vmTotalReh` int(11) DEFAULT NULL,
  `vmTotalGams` int(11) DEFAULT NULL,
  `vmTotalKlapphas` int(11) DEFAULT NULL,
  `vmTotalRollhas` int(11) DEFAULT NULL,
  `vmTotal` int(11) DEFAULT NULL,
  `vmTiefschussReh` int(11) DEFAULT NULL,
  `vmTiefschussGams` int(11) DEFAULT NULL,
  `fsStich1` int(11) DEFAULT NULL,
  `fsStich2` int(11) DEFAULT NULL,
  `fsStich3` int(11) DEFAULT NULL,
  `fsNachdoppel1` int(11) DEFAULT NULL,
  `fsNachdoppel2` int(11) DEFAULT NULL,
  `fsTiefschussstich1` int(11) DEFAULT NULL,
  `fsTotal` int(11) DEFAULT NULL,
  `smKlapphas1` int(11) DEFAULT NULL,
  `smKlapphas2` int(11) DEFAULT NULL,
  `smKlapphas3` int(11) DEFAULT NULL,
  `smKlapphas4` int(11) DEFAULT NULL,
  `smKlapphas5` int(11) DEFAULT NULL,
  `smKlapphas6` int(11) DEFAULT NULL,
  `smKlapphas7` int(11) DEFAULT NULL,
  `smKlapphas8` int(11) DEFAULT NULL,
  `smKlapphas9` int(11) DEFAULT NULL,
  `smKlapphas10` int(11) DEFAULT NULL,
  `smRollhas1` int(11) DEFAULT NULL,
  `smRollhas2` int(11) DEFAULT NULL,
  `smRollhas3` int(11) DEFAULT NULL,
  `smRollhas4` int(11) DEFAULT NULL,
  `smRollhas5` int(11) DEFAULT NULL,
  `smRollhas6` int(11) DEFAULT NULL,
  `smRollhas7` int(11) DEFAULT NULL,
  `smRollhas8` int(11) DEFAULT NULL,
  `smTontaube1` int(11) DEFAULT NULL,
  `smTontaube2` int(11) DEFAULT NULL,
  `smTontaube3` int(11) DEFAULT NULL,
  `smTontaube4` int(11) DEFAULT NULL,
  `smTontaube5` int(11) DEFAULT NULL,
  `smKlapphasTotal` int(11) DEFAULT NULL,
  `smRollhasTotal` int(11) DEFAULT NULL,
  `smTotal` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK resultate - schuetze` (`schuetze_id`),
  KEY `FK resultate-anlass` (`anlass_id`)
...
INSERT INTO `resultate` (`id`, `schuetze_id`, `anlass_id`, `vmReh1`, `vmReh2`, `vmReh3`, `vmGams1`, `vmGams2`, `vmGams3`, `vmKlapphas1`, `vmKlapphas2`, `vmKlapphas3`, `vmRollhas1`, `vmRollhas2`, `vmRollhas3`, `vmTotalReh`, `vmTotalGams`, `vmTotalKlapphas`, `vmTotalRollhas`, `vmTotal`, `vmTiefschussReh`, `vmTiefschussGams`, `fsStich1`, `fsStich2`, `fsStich3`, `fsNachdoppel1`, `fsNachdoppel2`, `fsTiefschussstich1`, `fsTotal`, `smKlapphas1`, `smKlapphas2`, `smKlapphas3`, `smKlapphas4`, `smKlapphas5`, `smKlapphas6`, `smKlapphas7`, `smKlapphas8`, `smKlapphas9`, `smKlapphas10`, `smRollhas1`, `smRollhas2`, `smRollhas3`, `smRollhas4`, `smRollhas5`, `smRollhas6`, `smRollhas7`, `smRollhas8`, `smTontaube1`, `smTontaube2`, `smTontaube3`, `smTontaube4`, `smTontaube5`, `smKlapphasTotal`, `smRollhasTotal`, `smTotal`) VALUES
(1, 1, 1, 10, 9, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 3, 4, 8, 11, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Tabellenstruktur für Tabelle `schuetze`
--

DROP TABLE IF EXISTS `schuetze`;
CREATE TABLE IF NOT EXISTS `schuetze` (
  ...
  `jahrgang` smallint(6) NOT NULL,
  `ort` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4;

--
-- Daten für Tabelle `schuetze`
--

INSERT INTO `schuetze` (`id`, `vorname`, `nachname`, `jahrgang`, `ort`) VALUES
(1, 'Manuel', 'Matter', 2003, 'Oberägeri'),
(2, 'Heinz', 'Müller', 1950, 'Alosen'),
(3, 'Kevin', 'Häusler', 1990, 'Unterägeri'),
(4, 'Alfred ', 'Weber', 1968, 'Zug'),
(5, 'Anna', 'Muster', 1959, 'Zug');
...
CREATE TABLE IF NOT EXISTS `schulferien` (
  ...
  PRIMARY KEY (`schulort`,`startdatum`),
  UNIQUE KEY `id` (`id`),
  KEY `schulort` (`schulort`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `_absenz`;
CREATE TABLE IF NOT EXISTS `_absenz` (
...
DROP TABLE IF EXISTS `_berechtigung`;
CREATE TABLE IF NOT EXISTS `_berechtigung` (
...
('ADM', 'Administrator', 'Administratorechte', 1),
...
DROP TABLE IF EXISTS `_kostenstelle`;
CREATE TABLE IF NOT EXISTS `_kostenstelle` (
...
DROP TABLE IF EXISTS `_lehrberuf`;
CREATE TABLE IF NOT EXISTS `_lehrberuf` (
...
DROP TABLE IF EXISTS `_lehrgang`;
CREATE TABLE IF NOT EXISTS `_lehrgang` (
  `id` varchar(25) NOT NULL,
...
DROP TABLE IF EXISTS `_schulort`;
CREATE TABLE IF NOT EXISTS `_schulort` (
...
DROP TABLE IF EXISTS `_taetigkeit`;
CREATE TABLE IF NOT EXISTS `_taetigkeit` (
  `id` varchar(5) NOT NULL,
...
--
-- Constraints der Tabelle `resultate`
--
ALTER TABLE `resultate`
  ADD CONSTRAINT `FK resultate - schuetze` FOREIGN KEY (`schuetze_id`) REFERENCES `schuetze` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `FK resultate-anlass` FOREIGN KEY (`anlass_id`) REFERENCES `anlass` (`id`) ON UPDATE CASCADE;
